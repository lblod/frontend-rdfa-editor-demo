...
import { consume, deprecateMutationsInAutotrackingTransaction, get, set, tagFor, tagForProperty, track, watchKey, PROPERTY_DID_CHANGE, computed, alias, isTracking, objectAt, runInAutotrackingTransaction, ARGS_PROXY_TAGS, untrack } from '@ember/-internals/metal';
...
import { unreachable, expect, Stack, EMPTY_ARRAY, dict } from '@glimmer/util';
      ...
      if (HAS_NATIVE_PROXY) {
        let handler = {
          ...
          getOwnPropertyDescriptor(_target, prop) {
            assert('args proxies do not have real property descriptors, so you should never need to call getOwnPropertyDescriptor yourself. This code exists for enumerability, such as in for-in loops and Object.keys()', capturedArgs.named.has(prop));
            return {
              enumerable: true,
              configurable: true
            };
