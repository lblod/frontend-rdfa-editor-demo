import { meta, peekMeta, UNDEFINED } from '@ember/-internals/meta';
import { setListeners, Cache, setWithMandatorySetter, lookupDescriptor, getDebugName, isEmberArray, setupMandatorySetter, symbol, HAS_NATIVE_PROXY, toString, inspect, getName, setName, getListeners, getObservers, getOwnPropertyDescriptors, guidFor, makeArray, ROOT, setObservers, wrap } from '@ember/-internals/utils';
import { assert, deprecate, warn, debug } from '@ember/debug';
import { DEBUG } from '@glimmer/env';
import { _WeakSet, assign } from '@ember/polyfills';
import { combine, CONSTANT_TAG, update, createUpdatableTag, dirty, CURRENT_TAG, validate, value } from '@glimmer/reference';
