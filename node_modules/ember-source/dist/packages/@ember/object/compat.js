import { consume, isElementDescriptor, setClassicDecorator, tagForProperty, track } from '@ember/-internals/metal';
import { assert } from '@ember/debug';
import { update } from '@glimmer/reference';
...
export function dependentKeyCompat(target, key, desc) {
  assert('The dependentKeyCompat decorator can only be used if the tracked properties feature is enabled', Boolean(true
